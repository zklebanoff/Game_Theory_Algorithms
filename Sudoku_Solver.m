%THIS IS AN EARLIER VERSION OF THE ALGORITHM I MADE, THIS CAN ONLY SOLVE
%SUDOKU PUZZLES WITH ONE UNIQUE SOLUTION, THE OTHER VERSION I SUBMITTED CAN
%SOLVE SUDOKU PUZZLES WITH MULTIPLE SOLUTIONS...THE OTHER VERSION IS THE
%ONE I USED TO SOLVE THE SUDOKU PUZZLE IN THE HOMEWORK

%Homework 7 Problem 7
%   Zackary Klebanoff

function [F,iterations] = HW7P7(M,T)
